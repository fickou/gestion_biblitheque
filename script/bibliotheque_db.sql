...
CREATE TABLE `notifications` (
  ...
  `relatedBookId` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `users` (`id`, `name`, `email`, `firebase_uid`, `matricule`, `roleId`, `avatarText`, `status`, `createdAt`, `updatedAt`) VALUES
(1, 'Jean Dupont', 'jean.dupont@univ.edu', NULL, '2024-UFR-001', 3, 'JD', 'actif', '2025-12-04 23:13:33', '2025-12-04 23:13:33'),
(2, 'Amadou Diallo', 'amadou.diallo@univ.edu', NULL, '2024-UFR-002', 3, 'AD', 'actif', '2025-12-04 23:13:33', '2025-12-04 23:13:33'),
(3, 'Fatou Sall', 'fatou.sall@univ.edu', NULL, '2024-UFR-003', 3, 'FS', 'actif', '2025-12-04 23:13:33', '2025-12-04 23:13:33'),
(4, 'Moussa Ndiaye', 'moussa.ndiaye@univ.edu', NULL, '2024-UFR-004', 3, 'MN', 'actif', '2025-12-04 23:13:33', '2025-12-04 23:13:33'),
(5, 'Aïssatou Ba', 'aissatou.ba@univ.edu', NULL, '2024-UFR-005', 3, 'AB', 'actif', '2025-12-04 23:13:33', '2025-12-04 23:13:33'),
(6, 'Ibrahima Sarr', 'ibrahima.sarr@univ.edu', NULL, '2024-UFR-006', 3, 'IS', 'actif', '2025-12-04 23:13:33', '2025-12-04 23:13:33'),
(7, 'Mariama Sy', 'mariama.sy@univ.edu', NULL, '2024-UFR-007', 3, 'MS', 'actif', '2025-12-04 23:13:33', '2025-12-04 23:13:33'),
(8, 'Cheikh Fall', 'cheikh.fall@univ.edu', NULL, '2024-UFR-008', 3, 'CF', 'actif', '2025-12-04 23:13:33', '2025-12-04 23:13:33'),
(9, 'Admin System', 'admin@library.edu', NULL, 'ADMIN-001', 1, 'AS', 'actif', '2025-12-04 23:13:33', '2025-12-04 23:13:33'),
...
ALTER TABLE `books`
  ADD PRIMARY KEY (`id`),
  ADD KEY `books_ibfk_1` (`categoryId`);
...
ALTER TABLE `emprunthistory`
  ...
  ADD KEY `emprunthistory_ibfk_1` (`empruntId`);
...
ALTER TABLE `emprunts`
  ...
  ADD KEY `emprunts_ibfk_1` (`bookId`);
...
ALTER TABLE `notifications`
  ADD PRIMARY KEY (`id`),
  ADD KEY `userId` (`userId`),
  ADD KEY `notifications_ibfk_2` (`relatedBookId`);
...
ALTER TABLE `reservations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `userId` (`userId`),
  ADD KEY `reservations_ibfk_1` (`bookId`);
...
--
-- AUTO_INCREMENT pour la table `emprunthistory`
--
ALTER TABLE `emprunthistory`
...
--
ALTER TABLE `emprunthistory`
  ADD CONSTRAINT `emprunthistory_ibfk_1` FOREIGN KEY (`empruntId`) REFERENCES `emprunts` (`id`);

--
-- Contraintes pour la table `emprunts`
--
ALTER TABLE `emprunts`
  ADD CONSTRAINT `emprunts_ibfk_1` FOREIGN KEY (`bookId`) REFERENCES `books` (`id`);

--
-- Contraintes pour la table `notifications`
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `notifications_ibfk_2` FOREIGN KEY (`relatedBookId`) REFERENCES `books` (`id`);

--
-- Contraintes pour la table `reservations`
--
ALTER TABLE `reservations`
  ADD CONSTRAINT `reservations_ibfk_1` FOREIGN KEY (`bookId`) REFERENCES `books` (`id`);
